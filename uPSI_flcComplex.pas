...
begin
  ...
  begin
    ...
    RegisterMethod('Procedure Assign0( const C : TComplex);');
    ...
    RegisterMethod('Function Duplicate : TComplex');
    RegisterMethod('Function IsEqual2( const C : TComplex) : Boolean;');
    ...
    RegisterMethod('Procedure Power( const C : TComplex)');
  end;
end;
...
(*----------------------------------------------------------------------------*)
Procedure TComplexClassDivide10_P(Self: TComplexClass;  const C : TComplex);
...
(*----------------------------------------------------------------------------*)
Procedure TComplexClassMultiply8_P(Self: TComplexClass;  const C : TComplex);
...
(*----------------------------------------------------------------------------*)
Procedure TComplexClassSubtract6_P(Self: TComplexClass;  const C : TComplex);
...
(*----------------------------------------------------------------------------*)
Procedure TComplexClassAdd4_P(Self: TComplexClass;  const C : TComplex);
...
(*----------------------------------------------------------------------------*)
Function TComplexClassIsEqual2_P(Self: TComplexClass;  const C : TComplex) : Boolean;
...
(*----------------------------------------------------------------------------*)
Procedure TComplexClassAssign0_P(Self: TComplexClass;  const C : TComplex);
...
(*----------------------------------------------------------------------------*)
procedure TComplexClassAsStringB_W(Self: TComplexClass; const T: RawByteString);
begin Self.AsStringB := T; end;

(*----------------------------------------------------------------------------*)
procedure TComplexClassAsStringB_R(Self: TComplexClass; var T: RawByteString);
...
begin
  ...
  begin
    ...
    RegisterMethod(@TComplexClassAssign0_P, 'Assign0');
